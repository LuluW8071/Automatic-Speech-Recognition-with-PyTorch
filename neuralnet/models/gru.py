...
class SpeechRecognition(nn.Module):
    ...
    # Initialize the hidden state of the GRU for live-streaming ASR output
    def _init_hidden(self, batch_size):
        n, hs = self.num_layers, self.hidden_size
        return (torch.zeros(n * 2, batch_size, hs))          # x2 for handling bidirectional
